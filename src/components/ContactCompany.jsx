...
const ContactCompany = () => {
    ...
    const contactData = [
        { name:'WhatsApp', data:'+62 812-3456-7890', icon:'fa-brands fa-whatsapp' },
        { name:'Email', data:'Exclusive@gmail.com', icon:'fa-regular fa-envelope' },
        { name:'Phone', data:'+62 812-3456-7890', icon:'fa-solid fa-phone' },
        { name:'Linkedin', data:'linkedin.com/in/exclusive', icon:'fa-brands fa-linkedin-in' },
    ]
    return (
            ...
            <div className="w-[90%] mx-auto mt-10">
                    ...
                    {contactData.map((item) => (
                        <div key={item.id} className="w-64 h-40 border-2 border-black rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out bg-white hover:bg-black hover:text-white hover:scale-105 active:scale-95">                        
                            <div className="flex flex-col items-center justify-center  text-center">
                                <i className={`${item.icon} fa-2xl mt-10`}></i>
                ...
                <div className="mt-10 pb-10" data-aos="fade-up">
                    <div className="flex items-center justify-center space-x-2">
                        ...
                        <i class="fa-solid  fa-location-dot text-red-500 pe-4 mt-1 text-[2.6rem]"></i>
